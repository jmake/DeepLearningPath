...
import pytubefix
import pytubefix.cli 


def YouTubeDownload(url) :
    ##url = "https://www.youtube.com/watch?v=FWM7yGZDvbk"

    yt = pytubefix.YouTube(url, on_progress_callback = pytubefix.cli.on_progress)
...
url = "https://www.youtube.com/watch?v=FWM7yGZDvbk"
video_path = YouTubeDownload(url) 

computerVision = ComputerVision() 
#computerVision.FromRealTime()  
computerVision.FromVideo(video_path)
